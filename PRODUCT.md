...
- Load an address starts by dropping the backup JSON. Entering parameters manually is secondary. A mismatch stays on that sheet.
- A saved escrow is a tile. Opening it shows Release and Refund.
- Unroll, unilateral exit, and the buyer and seller keys stay under Advanced. The oracle key is in Settings.
